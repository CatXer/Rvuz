...
public class DateT {
    ...
    public final static int START_LESSON_DAY = 246;
    public final static int START_LESSON_NEWYEAR = 119;
    public final static int END_LESSON_DAY = 182;
    public final static int TOTAL_DAYS = 301;


    public static String months[] = {"Января", "Февраля", "Марта", "Апреля", "Мая", "Июня", "Июля", "Августа", "Сенября",
